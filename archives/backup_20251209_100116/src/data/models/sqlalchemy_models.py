...
class CostItemMaterial(Base):
    """Association table for cost items and materials"""
    __tablename__ = 'cost_item_materials'
    
    cost_item_id = Column(Integer, ForeignKey('cost_items.id'), primary_key=True)
    ...
    def __repr__(self):
        return f"<CostItemMaterial(cost_item_id={self.cost_item_id}, material_id={self.material_id})>"
