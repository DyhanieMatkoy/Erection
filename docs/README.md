...
- **New Users**: Start with [User Guide](user-guide/)
- **Developers**: See [Developer Guide](developer-guide/)
- **Deployment**: Check [Deployment](deployment/) section
- **Latest Changes**: View [Changelogs](changelogs/)

## Getting Started

1. For installation instructions, see the [User Guide](user-guide/)
2. For development setup, refer to the [Developer Guide](developer-guide/)
3. For deployment information, check the [Deployment](deployment/) section
...
- Include version numbers in changelog files
- Use language prefixes for non-English documentation

## Support

For questions about documentation:
- Check the relevant section first
- Look in the [Troubleshooting](user-guide/) guides
