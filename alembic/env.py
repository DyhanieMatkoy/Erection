...
def get_url():
    """Get database URL from env.ini configuration"""
    db_config = DatabaseConfig("env.ini")
    db_type = db_config.get_db_type()
    config_data = db_config.get_config_data()
    return ConnectionStringBuilder.build_from_config(db_type, config_data)
