@echo off
REM Migrate database from SQLite to Microsoft SQL Server
REM Usage: migrate_to_mssql.bat [source_db] [target_config]
...
if "%TARGET_CONFIG%"=="" set TARGET_CONFIG=env_mssql.ini

echo ============================================================
echo Database Migration Tool - SQLite to MSSQL
echo ============================================================
echo.
...
if %ERRORLEVEL% EQU 0 (
    ...
    echo 3. Update env.ini to use MSSQL permanently
